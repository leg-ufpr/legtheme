...
% Include logos
\titlegraphic{\includegraphics[width=1.5cm,height=1.5cm]{logo/leg.pdf}\hfill
  \includegraphics[width=3cm,height=1.5cm]{logo/ufpr.pdf}\hfill
  \includegraphics[width=1.5cm,height=1.5cm]{logo/dest.pdf}\hfill
}
